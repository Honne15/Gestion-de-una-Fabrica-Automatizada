...
public class Robotica extends LineaProduccion {
    ...
    public void producir(Scanner scanner) {
        ...
        if (pabilo.equals("\nPabilo no disponible para esas medidas.")) {
            System.out.println(pabilo);
            System.out.println("Se detiene la producción de esta línea.");
            return;
        }
        ...
        cantidadEnvases = scanner.nextInt();
